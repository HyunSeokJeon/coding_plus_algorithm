...
conn = sqlite3.connect('C:/Users/sjunh/Documents/GitHub/python_basic/resource/database.db', isolation_level=None) # isolation_level = None autocommit
...
# 커밋 : isolation_level = None 일 경우 자동 반영(autocommit)
# autocommit이 아닐경우
# conn.commit()
# 롤백
# conn.rollback()
